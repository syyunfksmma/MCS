...
- ~~Shared drive directories match snapshot manifest.~~ (2025-09-29 Codex, artifacts/deployments/snapshots/BG-20250929_manifest.json)
- ~~Smoke CI passes post-restore.~~ (2025-09-29 Codex, docs/sprint/Sprint8_Log.md)
- ~~Grafana alerts return to green within 10 minutes.~~ (2025-09-29 Codex, docs/observability/Phase10_MonitoringDashboard.md)
