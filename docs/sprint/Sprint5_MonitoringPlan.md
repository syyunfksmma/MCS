...
## 4. TODO
- Telegraf 구성 파일 deploy/telegraf/web-vitals.conf 체크인 (2025-09-29 Codex, monitoring/telegraf/web-vitals.conf)
- Grafana Dashboard UID 등록 (Ops) (UID: mcms-s6-core 문서화)
- Alertmanager 라우팅 규칙 작성 (monitoring/alerts/mcms_core.yaml 참조)
