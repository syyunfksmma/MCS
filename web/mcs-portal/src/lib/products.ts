...
const MOCK_PRODUCTS: ProductSummary[] = [
  {
    ...
    solidWorksPath: "\\\\MCMS_SHARE\\\\Routing\\\\GT-3100\\\\3DM\\\\GT-3100.3dm",
  ...
  },
  {
    ...
    solidWorksPath: "\\\\MCMS_SHARE\\\\Routing\\\\SH-2001\\\\3DM\\\\SH-2001.3dm",
...
export async function fetchProductDashboardData(): Promise<ProductDashboardResponse> {
  ...
  try {
    ...
    console.warn("[fetchProductDashboardData] falling back to mock data", error);
    return getProductDashboardMockData();
  }
}
